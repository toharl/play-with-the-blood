...
# path(PATH+'/logs/WAE/')
# path(PATH+'/logs/T/')
# ae_tb_counter = len([log for log in os.listdir(os.path.expanduser('./logs/AE/')) if 'rac_' in log]) + 1
# ae_tensorboard = TensorBoard(log_dir=os.path.expanduser('./logs/AE/') + 'rac_' + '_' + str(ae_tb_counter),
#                           histogram_freq=0,
#                           write_graph=True,
#                           write_images=False)
#
# tb_counter = len([log for log in os.listdir(os.path.expanduser('./logs/WAE')) if 'rac_' in log]) + 1
# tensorboard = TensorBoard(log_dir=os.path.expanduser('./logs/WAE/') + 'rac_' + '_' + str(tb_counter),
#                           histogram_freq=0,
#                           write_graph=True,
#                           write_images=False)
#
# ttb_counter = len([log for log in os.listdir(os.path.expanduser('./logs/T/')) if 'rac_' in log]) + 1
# ttensorboard = TensorBoard(log_dir=os.path.expanduser('./logs/T/') + 'rac_' + '_' + str(ttb_counter),
#                           histogram_freq=0,
#                           write_graph=True,
#                           write_images=False)
#
